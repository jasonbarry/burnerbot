...
$camps = array(
	...
	"Scar Bar aka Bermuda Triangle",
	"Spandex and Steroids",
	"The Resistance",
	"(My First) Period Bar",
	"(TMWC) Martial Law Camp",
	"(TMWC) The Rusty Hanger, BRC Sexual Wellness Clinic",
	")'( Recycle Kids Toy Shop",
	")*(Aloha = H'Aloha",
	"* Cats",
	"* Cats / The Hive",
	...
	"1001 Nights",
	"11 Forward",
	"2011 KING OF CARNAVAL CAMP",
	"3 Old Men: a ritual troupe",
	"404:// Village Not Found",
	"64 Arts",
	"7 Centers Sacred Living",
	"7 Deadly Gins",
	"7 Sins Lounge",
	"7 Sirens Cove",
	"80s dance party camp",
	"9 Energies",
	"9th District BRPP",
	"A 1776 Masquerade",
	"A Brand Gnu Ewe",
	...
	"Academy of Fools",
	"Academy of Rogue Therapists (ART)",
	"Acampamento HUITZIL HUITZIL",
	"ACME Enterprises",
	"ACME Exploration Corporation",
	"Acoustic Combustion",
	"Adult Playspace",
	"Adult SuperVision",
	"Advancement of This and Improvement of That",
	"Advice Booth Camp",
	"Afternoon Respite",
	"Airport Muse",
	"Airport Village",
	...
	"Airship Victoria",
	"Airship Victoria Aerodrome",
	"Airship Victoria, Camp Victoria",
	"Airstreameri & Geologists",
	"Airstreameri and Geologists",
	"Airstreameri and Geologists and Gynocologists",
	"Airstreameri and Whatnot",
	"AKAirways: Think Inflatable",
	...
	"And then there's only LOVE",
	"And then there's only LOVE...",
	"Angels, Shamans, Healers & Yogis",
	"Angler's Domain",
	"Angry Birds Camp",
	"ANITA COCKTAIL",
	"Annex Camp",
	"Anonymous Village",
	"Anonymous Village - AV",
	"Another Castle",
	"Anthony's Disco Bar & Hula Lounge",
	"Anti M's Home for Wayward Art",
	"AO",
	"Apex Camp",
	"Apocalypse Later",
	...
	"Appa Camp",
	"Appa Jam Camp",
	"Apres Ski & Great White North",
	"Apres Ski BRC",
	"Apres Ski Chalet",
	"Après Ski Black Rock City",
	"Après ski BRC",
	"Aqua Lounge",
	...
	"Ashram Galactica",
	"Ashram Galactica",
	"Ashram Galactica Resort and Conference Center",
	"Asparagus Burn Camp",
	"Asparagus Forest",
	"Ass Stamp Camp",
	"Astral Headwash",
	...
	"Bandan-Aroma and Bandana Brigade",
	"Bang Bang",
	"Bang! Bang!",
	"Banya Camp",
	"Bao Chicka Wow Wow",
	...
	"Battle Born Burners",
	"Battlestar Erotica",
	"Bavarian Illuminati M/C Camp",
	"Bayesian Conspiracy",
	"BC Village",
	"Be There Now",
	"Beach @ the End of the Universe",
	"Beach @ The End of The Universe",
	"Beach at the End of the Universe",
	"Beans, Beans Musical Camp",
	"Beats Boutique",
	...
	"Biggest lit'l Smores on the Playa",
	"Bike & Booze",
	"Bike Course Camp",
	"Bike Gods",
	"Bike Rock City",
	...
	"Bioluminat / Pimp Yr Bike",
	"Bioluminati / Bike Mutation",
	"Bioluminati / Pimp Yr Bike",
	"BIQ HQ",
	"Bitch 'n' Tea",
	"Bitches and Barkers Doggy Daycare",
	"Bitchin' Braid Camp",
	"Bizarre Bazaar",
	"Black Magic Monkey",
	"Black Planet",
	"Black Rock Academy",
	"Black Rock Army",
	"Black Rock Astronomical Society",
	"Black Rock Bakery",
	"Black Rock Beacon",
	"Black Rock Bijou Camp",
	"Black Rock Botanica",
	"Black Rock Boutique",
	"Black Rock Brewery",
	"Black Rock Brews",
	...
	"Black Rock City Bass & Booze",
	"Black Rock City Boardwalk",
	...
	"Black Rock City Welding And Repair",
	"Black Rock Cultural Center",
	"Black Rock Diner",
	...
	"Black Rock Power CO-OP",
	"Black Rock Power COOP",
	"Black Rock Prep - Road Scholars",
	...
	"Blacklight ObstacleCourse Croquet",
	"BLM & Pershing County Sheriff's Substation",
	"BLM Interpretive Camp",
	"BLM / Pershing County LawEnforcement",
	"BloAsis Village",
	"Block Party",
	"Blood Bath & Beyond",
	"Blood, Rust & Gin",
	...
	"Blue Lotus",
	"Blue Oasis",
	"Blue Pig Pet Appreciation Plaza",
	"BLUE TEAM",
	"Blukis",
	...
	"BOCCE BANDIS",
	"Bojon Balance Camp",
	"Bojon Birds, Bees, Bunnies and Balance Camp",
	"Bonehead Beach Club",
	"Boo Boo City",
	"Boobs, Bikes, and Bees Camp",
	"Booby Bar",
	"Bookmobile! Choose Your Adventure",
	"Boonville Cabaret",
	"Boosh Camp",
	"Boosh Camp - Inter-Continental Edition",
	...
	"Botanica Bodhi Manman Bejeezus",
	...
	"BrassTax Radio Malibu",
	"Brave New Melon Camp",
	...
	"Burning Band",
	"Burning Band Camp",
	"Burning Bedouins hospitality camp",
	"Burning flix camp",
	"Burning Man Bike Course",
	"Burning Man Earth",
	"Burning Man Earth (DEPT)",
	"Burning Man Information Radio",
	"Burning Man Outreach Network",
	"Burning Man Studios",
	"Burning Man T-Shirt Factory",
	"Burning Manischewitz",
	"Burning Phone Camp",
	"Burning Phone / Camp Soft-Rock",
	...
	"Camp be seen",
	"Camp Beaverton",
	"Camp Beaverton for Wayward Girls",
	"Camp Bedrock",
	"Camp Bitcoin",
	"Camp BollyRock",
	"Camp Boom Boom Womb",
	...
	"Camp Do Nothing",
	"Camp do nothing",
	"Camp Do Nothing, Part Deux",
	"Camp Dodgeball Addiction",
	"Camp DOPE",
	"Camp Dusty Sanchez",
	"Camp Eden",
	...
	"Camp Foster",
	"Camp Fuck Yeah",
	"Camp Fuego's Karaoke Lounge & Top-Shelf-Only Bar",
	"Camp Fun Your FACE",
	"Camp Gallavant",
	"Camp Glamazon",
	"Camp Glitz",
	...
	"Camp Journeylizm",
	"CAMP JUICY",
	"CAMP JUICY / FREQUENCY",
	"Camp Karuna",
	"Camp Kegel Kommandos",
	"Camp Kiki",
	"CAMP KLEPTO",
	"Camp L*(ife) E*(nhancement)",
	"Camp LaLa",
	"Camp Lamp",
	"Camp Last Year",
	"Camp Lazy Girl",
	...
	"Camp Narc",
	"Camp Narc!",
	"Camp Natural Selection",
	"Camp Naughty Bench",
	"Camp Nevada The Way It Was",
	"Camp New Jersey",
	"Camp New Year",
	"Camp Nice Nice",
	"Camp No Toil",
	...
	"Camp P6",
	"Camp Pair-a-dice",
	"Camp PB&J: Tickling Pickles",
	"Camp Peace of Ass",
	"Camp Peace of Ass; aka Camp Bootylicious",
	"Camp Pendant",
	"Camp Photon",
	"Camp Pickleback",
	"Camp Pickled Monkey",
	...
	"Camp Thump Thump",
	"Camp Titicaca",
	"Camp Titteebumpa aka Charlie Sheen Center for Depraved",
	"Camp To Be Continued",
	"Camp Toga! Toga! Toga!",
	"Camp Touch This",
	"Camp Tough Love",
	"CAMP TROPICAL TWISTER",
	"Camp Turn n' Burn",
	"Camp Unofficial",
	"Camp Unofficial Presents: The Monster Wheel Grand Prix",
	"Camp Upsie Dasium",
	"Camp Vagikal",
	"Camp Validation",
	"Camp Ventana",
	...
	"Carbon Dioxide Camp",
	"Career Ending Footage",
	"CARGO CULT? IN CARGO, WE ELVISPRESSO!",
	"CARNIE GAMES!",
	"Carnival del Fuego",
	...
	"Cascadian Village: Dumpster Dive Bar",
	"Cascadian Village: Dumpster Dive Bar / High Strung",
	"Castle Anomalous",
	"Cat's Meow",
	"Catch and Release",
	"Cavern Tavern",
	...
	"Census Lab",
	"Center Camp Cafe",
	"Center Camp Medical Clinic",
	"Center of gravity",
	"Center Of Gravity",
	"Center Of Gravity (Dancetronauts)",
	"Cereal Thrillers",
	"Cereal thrillers",
	...
	"Cheezy Porn Camp",
	"Chez Andre",
	"Chico Urban Area Docking Port",
	"Children of Chaos",
	"Children of Chaos Farewell Tour",
	"Chill Ville",
	"The Chillage",
	...
	"Church of The Perpetual Party",
	"Church Trap Revival Camp",
	"Circle Academy",
	"Circle Rules Football Camp",
	"Circus Boot Camp",
	"Circus Combustus",
	"Circus Jerk",
	"Circus Metropolus",
	...
	"COM Association of Social Services",
	"Combobulated Misfit Fuckaye Control",
	"Comfort & Joy",
	"Comfort & Joy Village",
	"Comfort and Joy",
	...
	"Cosmic Giggle",
	"Cosmic Recess",
	"Cosmic Recess / Lustre Village",
	"Cosmic Toy Camp",
	"Cosmical Proot Temple",
	...
	"CouchSurfing Camp",
	"Coulrophobia Camp",
	"Couple of Crazy Cats",
	"Covered In Bees",
	"Covered in Bees",
	"Cozmik Dust",
	"CPT Presents: Crunklantis",
	"Crackwhore Camp",
	...
	"Cult of the Sacred Cow Go",
	"Curiouser & Curiouser",
	"Curiouser and Curiouser",
	"Cutthroat Kitty Rumhouse",
	"D B Copper airport shuttle lounge",
	"D. PACTS Skin and Candy Bar",
	"Da Dirty Hands",
	"DA YING TEA HOUSE",
	"Daily Playa",
	"Dali Ville",
	"Damn Fucking Texans",
	"Dancing Shaman Vibe Tribe",
	"Dare to be Rare",
	...
	"Dirty Beetles",
	"Dirty Love Camp",
	"Dirty Santa's Magic Disco",
	"Disciples of the Dust",
	"Disco Chateau",
	"Disco Dokie",
	"Disco Knights",
	"Disco Shower Bar",
	"Disco Shower Bar and Desert Oasis",
	"Disco Space Shuttle",
	"DiscoFish Landing Strip",
	"DiscoFist & BurningVelvet",
	"Diva Nation",
	"Dj Rebellion",
	...
	"Dodgeball Addiction",
	"Dodgey Portrait -Turkey Cider Heads",
	"DodgeyPortrait ,Turkey CiderHeads",
	"Dodo's Nest",
	"Dome on the Range",
	...
	"Dr. Le Tawdries Apothecary",
	"Dr. Le Tawdry",
	"Dr. Le Tawdry Planet Earth",
	"Dr. Playa's Ear Nose and Throat Clinic",
	"Dr. Playa's Ear Nose&Throat Clinic",
	"Dr. Playas EarNose & Throat Clinic",
	"Dr. Baron von Realz Esq. Sideshow",
	"Dr. Carl's Department of Collections",
	"Dr. Carl's Dept. of Collections",
	"Dr. Fate's Potion Palace",
	"Dr. Le Tawdry's Panacea",
	"Dr. Placebo's Snake Oil Emporium",
	"Dr. Playa's Ear, Nose & Throat Clinic",
	"Dr. Realz mysterious wheel of uncertainty and mystical inclusion?",
	...
	"Dragon Smelter",
	"Dragon Smelter Camp",
	"Dragon Smelter Coin Operations",
	"Dragonfly Den",
	"Drama Camp",
	"DRAPES EVERYWHERE",
	"Dream Orphanage",
	"Dream Society",
	"Dreamachine: Inward Travel",
	"The Dreamaginatorium",
	"Dreamer's Playground",
	"Dreamers Guild",
	"DropIt Like Its Hott Spot",
	"Drums on the Playa",
	"Drunken Weenie Camp",
	"Dub Scouts",
	"Dub Scouts Troop 808",
	"Dubscouts Camp",
	"Duck Pond (I)",
	"Duck Pond (II)",
	"The Dump",
	...
	"Dusty Justice",
	"Dusty Lady",
	"DUSTY LAVEAU'S ENCHANTED EMPORIUM",
	"Dusty Lusty",
	"Dusty Nuts Tavern",
	"Dusty Phoenix",
	"Dusty Playaground",
	...
	"Dusty Swan Public Craic House and Celtic Cinema",
	"Dusty Taint",
	"Dye with Dignity",
	"Dye With Dignity",
	"Dyenamic Huephoria!",
	"Earth Guardians",
	"Earth Tribe Gone BRZRKR",
	"Earthlings Are Easy",
	"Earthlings are Easy",
	"Easel Park",
	"Easel park",
	"East Bay Burner's Camp",
	"East Bay Burners Camp",
	"East of Eden",
	"Easy Village",
	"EAT Me",
	"EAT Metaphysical Trading Post",
	"EBB and Glow",
	"Echoing Park",
	"Ecliptic Sun",
	"EE Camp: Magic Circus Band Camp",
	"Eggchtropolis Bar",
	"EGGS bar 2012",
	"Ego Trip",
	"Ego trip",
	"El Castor",
	"El Circo and The Do Lab",
	"El Dorado",
	"Electric Barbarella",
	"Electric Gypsy Coffee Oasis",
	"Electric Ladyland",
	"Electric Light Charade",
	"ELECTRO MAGNETIC",
	"Electromek Apotek",
	"Elements Village: Wind+Fire+Earth",
	"Elephant Bird Camp",
	"EleVant Rising",
	"Elk Lodge: Flora & Fauna",
	"Elliot's Bicycle Service",
	"Elvis Beer Garden and Wedding Chapel",
	"Elvis Wedding Chapel",
	"Elvis Wedding Chapel & 2.0 Fertility Gardens",
	"Elvis Wedding Chapel & Salvage Gardens 2013",
	"Elvis Wedding Chapel 2014",
	"Embassy Live",
	"Embassy Of Hardcore",
	"Embers Acoustic Lounge",
	"Emerald City",
	"Emerge-n-See Sparkle Pony Corral",
	"Emergency Services RAMPART Urgent Care",
	...
	"Energy Enema Camp",
	"Energy Riders",
	"EnHightened Beings of Leisure",
	"Entheon Village",
	"The Epic Queer Camp",
	"Eridu Society",
	"ESPRESSO CAMP",
	"Espresso Camp",
	"ESPRESSO CAMP / TACTICAL ESPRESSO SERVICE",
	"ESPRESSO CAMP_BLACK ROCK ARMY_BLACK ROCK POWER CO-OP",
	"Eubie lemming's dive bar",
	"Everybody Crew",
	"Everywhere Land",
	"Everywhere Pavilion",
	"Evil Office",
	"Evil Space Unicorns",
	"EVILution ~ City Of Fallen Angels",
	"EvoLLLution: the Lively Loving Lot",
	"Evolution #9 Cafe'",
	"Evolutn Obscura@Children of Chaos",
	"Expansion Mansion",
	"Express Lot",
	"Extinct Creatures",
	"Extreme Frequencies",
	...
	"F.U.N. Camp",
	"Fabulous Disaster",
	"Face Forward / Caged Pulse Jets Camp",
	"Face of Venus",
	"Fade to White - MN Midway",
	"FAFA Camp",
	"Fairy Tale Theater",
	"FALLOUT SHELTER",
	"Fallout Shelter",
	...
	"False Profit, Inc.",
	"False Profit, LLC",
	"Fantasy Funhouse & Wheel of Karma",
	"Feed the Artists",
	"Fer Sherbert",
	"FERN CAMP",
	"Fine Fire Arts camp",
	...
	"First Transdimensional Bank + Church",
	"First Transdimensional Bank+Church",
	"Fish Out of Water",
	"Five Ton Crane",
	"Fixxxation Station",
	...
	"Flamingos FTW!",
	"Flattery Camp",
	"Flatulence Ampflication Research Team",
	"Flights of Fancy",
	"Flirt Camp",
	"Flock Ewe",
	"Flow Camp",
	"Flow Federation",
	"Flower Camp",
	"FLOWER POWER GYPSY CAMP",
	"Fluffy Clouds",
	"Fluid Fortune",
	"Flying Falafels",
	"Fool's Melon",
	"Forestchild Village",
	"FourFathers of Saint Stupid Camp",
	"Fractal Nation",
	"Fractal Planet",
	"Fractal Presents~Persepolis Gates",
	"Fraggle Rock; Samurai and Puppet Dojo",
	"Frank's Kitchens",
	"Free Advice Camp - YGWYPF",
	"Free Breathing",
	"Free Fall",
	"Free Movement Zone",
	"Free Photography Zone",
	"Free Tribe-Tantra Temple",
	"The Freedom Lounge",
	"FreeForm Family",
	"FreeStyle Palace",
	"French Maid Brigade",
	...
	"Front Porch Sitters",
	"Frosty Phoques Iceberg Lounge",
	"Frozen Oasis",
	"Frum's Utopian Center for Kindred Spirits",
	"Fröccs Bár",
	"Fuck Balls YEAH!",
	"FUCK CLUB-PLEASURE DOME",
	"Fuck Your Guilt",
	"Fuck. balls.(yeah!) BIG BALL DERBY",
	"Fuckballs (yeah!) Imaginatours",
	"Fucking Flamingos",
	"Fucking Unicorn Camp",
	"Fujiyama disco",
	"Fun Connection",
	"Fun House",
	"Fun Yay Fun",
	...
	"Gallavant Goddesses & their Lost Boys",
	...
	"Ganesh's Rebirth Dilation Station",
	"Ganesh_s Transmutation Station",
	"Ganesh’s Boneyard Public House",
	"Garage Mahal",
	"Garden of DeLights",
	"Garden of Hedon",
	"Garden of Sensual Delights",
	"The Garden",
	"Gardeners of Missed Connections",
	"Gathering of the Sphere",
	"Gauchos del Fuego",
	"Gay Rd Village",
	"Gaylactic Invaders",
	...
	"GEISHA HOUSE",
	"Gender Blender",
	"Genesis: The Creationist Bar",
	"Genetic Mutant Petting Zoo",
	"Genital Portrait Studio",
	"GEO Dust II",
	"Geodestiny Tribe",
	...
	"Get Lost",
	"Get Nailed",
	"Get Nailed Salon @ Black Rock Reef",
	"Get Nailed ~ Nail Painting Salon",
	"Gherkin Lounge",
	...
	"Groove Oasis",
	"The Grotto and Garden of Manifest Destiny",
	"Grrr",
	...
	"Hipster Retirement Cruise",
	"Ho-Down Village",
	"Hobart's Secret Passage",
	"Hoe Garten",
	"Hokey Pokey Camp Man or Monkey",
	"Hokey Pokey Come Back",
	"Hokey Pokey Consortium",
	"Hokey Pokey Initiation",
	"Hokey Pokey Oasis",
	"Hokey Pokey Ovum",
	"HoldenMyNuts Garage",
	"HoldenMyNuts Self-Service Garage and Playa Hardware.",
	"Holi High Camp",
	"Home Base",
	...
	"Hotshot the Robot vs Robotronia",
	"House of Dust",
	"House of Sammich",
	"House of Skin",
	"House Of Skin",
	"House of Skin - Adult Playground",
	"House of YES",
	"Houston CORE Camp",
	"HOVerlandia - Burner Express Camp",
	"Huevos Ranch Eros",
	...
	"Illumintation Village",
	"Image Node",
	"Immortal Jellyfish",
	"In Dust We Trust",
	"IN DUST WE TRUST",
	"In-Tents-IV Care Unit",
	"Incendiary Intent",
	"Inebriation Nation",
	"Infinite Community",
	"Infinite Oasis",
	...
	"Iron Monkeys - Honorarium Support",
	"Iron Rose",
	...
	"JaggerBush Central Station",
	"Jake's Tent Charcuterie RV Camp",
	"James Brown Camp",
	"Janky Barge",
	"Janky Barge + Catmandu = <3",
	"JaXXXson JunXXXion",
	"Jelly Fields",
	"Jellyfish 12,000",
	"Jellyfish 12000",
	...
	"Just Show Up Camp",
	"Just the Tip Jousting",
	"K-SVERT 106.5 FM presents Sacramento Dave's Okie Corral",
	"K-SVERT 106.5 FM presents, Sacramento Dave's Okie Corral",
	"K-SVERT 106.5 FM Radio & Performan",
	"K-Svert 106.5FM Radio & Stage",
	"K-SVERTpres Sacdave's Okie Corral",
	...
	"Kardashev III",
	"Karma Chickens",
	"Karma Collectors Camp",
	"Kazbus Harem Pants Belly Dance",
	"Kazbus Kamp Presents: PLAYANESIA",
	"Kazbus Kamp Presents: Sinbad and Sheherezade's Harempants Bellydance",
	"KazbusKamp Transformation Station",
	"Kegel Kamp and Bijou Boutique",
	"Kegel Kamp and Jewelry Exchange",
	"Kegel Kommandos",
	"Kentucky Fertility Clinic",
	"Kentucky Flight Control (KFC)",
	"Kentucky Fried Camp",
	"Khan's Asylum",
	"Khufu's Stache",
	"Khufu's Stash",
	...
	"Kindergarten Kamp",
	"Kinetic Cab Company",
	"Kink'os Photo Lounge",
	"Kissing Dinos",
	"Knarly Carnival",
	"Knarly carnival",
	"Korova Milk Bar",
	"Kosmik Dust",
	"Kosmik Dust Pedal Pub Camp",
	...
	"L melon O P",
	"L'Homme Flambe",
	"L.E.D.'ers of the rEvolution",
	"La Calaca",
	"La Calaca Village",
	"Ladies' Vivant, Haus of Toniq",
	"LAF Camp",
	"LAFer Camp",
	"LAFer Camp and Porta Gallery",
	"Lahontan Korps",
	"Lair of The Lurking",
	"Lamplighter Chapel",
	"Lamplighter Village",
	...
	"Last Rites Lounge",
	"Laughing Monkey Camp",
	"Lava Lounge",
	"Lavender Lounge",
	"Lazerium DIY",
	"Lazy Lizard Lemonade Lounge",
	"Lazy Skool Daze",
	"Le Kaf",
	"Le Kafe",
	"Le Kafé",
	"Le Zoo",
	"LED Dinosaur",
	"Left of Passeggch Bar",
	"Legendary House of Booze on Black Rock Strip",
	"LEGO BAR",
	"Lego Land",
	"LEGO TRUCK STOP",
	"The Lemonade Stand",
	...
	"Leopard Martini Lounge / BRC Hash House Harriers",
	"Leopard Martini Lounge / BRCH3",
	"Leopard Martini Lounge / Black Rock Hash House Harriers",
	"Leopardy Lair",
	"Les mechants",
	"LET GO MY EGO & FLOW",
	"Let It Go",
	...
	"Lil Town",
	"Liminal Labs",
	"Liminal Labs - Amino Acid Arcade",
	"Liminal Labs - Virgin Initiation Program",
	"Liminal Labs Dust Xchange",
	"Liminal Labs present John Frum Security Theater",
	"Liminal Labs' Legba's Gate",
	"Lip Bomb",
	"Lip Service",
	"Liquid Baptism",
	"Liquid Latex Lounge",
	...
	"Lost & Found",
	"Lost Boys",
	"Lost City presents Cirque du SoGay",
	"Lost in Space Tribe",
	"Lost Lizard Lounge",
	"Lost Lizard Lounge / Plumber's Crack",
	"Lost Penguin",
	"The Lost Penguin",
	"Lotion Bar",
	"Love At First Bite",
	...
	"Lust For Life",
	"Lustre Village",
	"Lustrous In-Dust-rious",
	"LUX INCULTA",
	"Luxurious Vagrants",
	"M*A*S*H 4207th",
	"M*A*S*H 4207th / Black Rock Army",
	"MacGyvers' Union",
	"Machine Control Compound",
	"Mad Flava!",
	"Mage Camp",
	...
	"Make a Little Me",
	"Mal-Mart Mega Store",
	"Mal-Mart presents BAAL-MART",
	"Maliburn Beach",
	"Maliburn Village",
	"Malvoye Support Camp",
	"Mama Kabuke's Big Tent",
	"Mama's Whore's and S'mores",
	"Mansonian Inst. of Urban Studies",
	"Mansonian Institute",
	"Mansonian Institute of Urban Studies",
	"Marching Band Camp",
	"Martian Powder",
	"Martini Village",
	"MASH 4207th",
	"Math Camp @ Group W",
	"Matrushka's Roadhouse",
	"Mayan Fertility Temple",
	"Mayan Warrior",
	"Meadful Things",
	"Media Mecca",
	"Medical Clinic 5:15 Esplanade",
	"Medical Clinic Center Camp",
	...
	"Mind Shaft Society",
	"MiniMOO Camp",
	"Ministry of the Magical Mustache",
	"MINSTREL CrAMP",
	"MIR camp",
	"Miracle Fruit Camp",
	...
	"More Fun, Less Suck",
	"MORE MAN BOY",
	"Morning Margarita Maniacs!",
	"Mosaic Lounge",
	"Mosaic Lounge at PEX Village",
	"Most Dangerous Game Camp",
	...
	"Multi Multi Touch Touch Camp",
	"Multi Pass",
	"Musement Heights",
	"Museum of Industry Science & Tech",
	"Museum of Transportation History",
	"Museum of Unnatural History",
	"Mushroom Forest Disc Golf",
	"Music Savages",
	"Music Savages Camp",
	"Music Savages t-shirt Arena",
	"Mustache Camp",
	"Mustache Raunch",
	"MUTANT ALIEN BEAUTY SPA",
	"Mutant Bikology Camp",
	"Mutant Machine Town",
	"Mutant Mo's Last Chance Saloon",
	"Mutant Vehicle Repair",
	"Mutinous Picnic",
	"Mycodelic Forest",
	"Mystic Midway",
	"Mystikal Misfits",
	"Mystikal Misfits Oasis",
	"Mystikal Misfits return home",
	"Mystikal Misfits Waldorf Mystoria",
	"The Mystikal Misfits",
	...
	"Neo Evolutionary Logic Project ",
	"Neon Monkey",
	"Neon Monkeys",
	"Nevada Barbarians",
	"Neverwas Haul",
	...
	"Oden's Eye Apple Cider",
	"Off-Center Camp by Kamp Kabaam",
	...
	"Ooligan Airways",
	"Oontz Pouch",
	"OPHU & Cooperative Knowledgebase",
	"Opposable Thumbs",
	"Opulent DETH Temple",
	"Opulent Temple",
	"OraculTang Family",
	...
	"P3: The Princess Party Palace",
	"Paddy Mirage",
	"Painting your Patootie",
	"Painting Your Patootie",
	"Pair-a-dice @ The Beach",
	"Pair-a-dice Camp",
	"Palace of Balunsia",
	"Palinka Lounge",
	"Pam's Parlor",
	...
	"PEX Village",
	"The Phage",
	"Phantasmatis Apparatus",
	"Phasmantis Apparatus",
	"Philadelphia Container Camp",
	"Philadelphia Experiment Village",
	"Philly Phreak Show",
	"Philthy Sanchez / Camp... in Bed",
	"Phoenix Camp 2013",
	"Phoenix Circle Village",
	"Pi - monorail",
	"Pi Camp",
	"Picasso Camp",
	"Pickle Joint",
	"Pickleback Mountain",
	"PickleBack Mountain",
	"Pigamilions: Opposable Hooves",
	"Pigeon Palace",
	"Pigmalions: Boar Mitzvah",
	...
	"Pink Lightning",
	"Pink Mammoth",
	"Pink Parachute Booblz",
	"Pirate Ninja Training Camp",
	"PITA'S REVENGE",
	"Piñata's Revenge",
	"PI√ëATA'S REVENGE",
	"Plaisance - Carny Coral Backyard",
	"Plan B Laboratories",
	"Planet Earth",
	"PLANET NABU",
	"Planet Pink",
	...
	"Playa Pail Kids",
	"Playa Pete's Plaza",
	"Playa Piano Bar Camp",
	"Playa Pickup Technicolor Music",
	"Playa Practice Poi Camp",
	...
	"Pony Girl Express",
	"Pookah Lounge",
	"Pope Decadent's House of Beverage",
	"Porch Times",
	"Porn and Donuts",
	"Porn Karaoke Cacmp",
	"Pornchinko Parlor",
	...
	"Post Nuclear Family",
	"Post Office",
	"Postal Telegram Office",
	"Potato Camp",
	"PPC @ The Glitterbox",
	"PPR: The Prod Pump and Rest",
	"Practice Poi / Cotton Candy Camp",
	...
	"Pretty Pickle Camp",
	"Primate Playground",
	"Primate Playground & PLAYAEVENTS_GPS",
	"Primitive Technologies",
	"Primordial Swamp",
	"Pro Leisure Tour",
	"PROD Pump & Rest - Cafu Lait",
	"Prod Pump & Rest - Polka Dot Prom",
	"Prof. Pigeon's Psychedelicures",
	"Project Green House",
	"Projekteers Petri Dish",
	"Proverbial Palace",
	"Psychedelic Freakshow Camp",
	"Psychic Taxi",
	"Psycho Blubble Camp",
	...
	"Pyramid Cocoon (Pyracoco)",
	"Pyramid Park Place",
	"Pyramid Portal",
	"Pyramid Scheme the sequel.",
	"Pyronauts & Galactic Guardians Camp",
	"Pyronauts Camp",
	"Pyschic Taxi",
	"Quantum Beats",
	"QUE VIVA! CAMP",
	"Que Viva! Camp",
	"Queen Dick",
	"Question Everything Camp",
	"Questionable Behavior",
	"Quixote's Cabaret Club and Bar",
	"Quixotes Cabaret Club and Bar",
	"Quixotes Cabaret Club: the Temple of Fertile Imagination",
	"Quixotes Cabaret Present The Duke of Edinburgh Arms",
	"Quixotes Cabaret Presents The Flashman Arms",
	"Quixotes Presents The Man and Monkey Pub",
	"Quixotes Presents “The Dr’s Box”",
	"Rack em Up",
	"Rack em Up!",
	"Radio Electra",
	"Radio Electra 89.9 FM",
	"Radio Free Burning Man",
	"Rainbow and Tetanus Society",
	"The Rainbow and Tetanus Society",
	"Rainbow Bridge",
	"Rainbow OASIS",
	"Rainbow sapians",
	"RAIR-Return of Arson Island Resort",
	"Raised by Wolves",
	"Raising the Dead",
	"RAMPART Urgent Care",
	"Rancho Amarillo Collective",
	"Rancho Sparkle Pony",
	...
	"Ranger Outpost Moscow",
	"Ranger Outpost Tokyo",
	"Ranger Outpost Tokyo & the 10-7 Lounge",
	"Rat Camp",
	"Rat Trap",
	"Rave'Ns Nest",
	"Rave'Ns Reskew Mission",
	"Re: BIRTH Village",
	"Reading Rainbow",
	"Reality Check TV",
	"Reared In Steel",
	...
	"Reggae Wine Bar & Wedding Arch",
	"Reincarnation and Penance",
	"Reincarnation Location",
	"Reincarnation Lounge & Day Spa",
	"ReinKarmation Station",
	"Relaxomatic Plushitorium",
	"Remedial Kindergarden Camp",
	"Remedial Kindergarten Camp",
	"Reno Housewives",
	"Reno Nation",
	...
	"Resurrection Camp",
	"REVELATION FEDERATION",
	"Reverbia",
	"Reverbia: All Live Music Camp",
	"Reverend Billy & The Church of Stop Shopping",
	"Revolution Camp",
	"Revolution Camp, HQ of Department of Public Words",
	"REVOLVE Your Balls",
	...
	"The Rising Arms",
	"Rites of Assage",
	"Rites of Spring! Camp",
	"Rites Of Zion",
	"Rites, Rituals, and Traditions",
	"Riviera Beach",
	"Roarax Rounge",
	"Roasted Breaux & Coffee Heaux",
	"Roasted Breaux and Coffee Heaux",
	"Robonia Camp and Turjmahal",
	"Robot Heart",
	"Robot Invasion Survival",
	"Rock Bottom",
	"Rock n Bowl",
	"Rock Star",
	"RockStar Orphans",
	...
	"Sake To Me",
	"Sake Watering Hole",
	"Sala Of Unnamed Love",
	"Salon 7",
	"Salon 7",
	"Salon Soleil",
	"Salty Jack's",
	"Salty Jack's Oily Rig",
	"Salty Jacks",
	"Salute Your Jorts!",
	"Samadhi Vision",
	"Samba Stilt Circus",
	...
	"Science Vs Superstition: ChessKamp",
	"Scotch & Hop",
	"Scotch and Hop",
	"Scrabble Camp",
	"Sea Anomaly Camp",
	...
	"Sharkey's Bar and Lounge ",
	"Shaved Ice Pussy",
	"Ship Wreck Tiki Lounge",
	"Shipibo Vapor Bath Camp",
	"Shipwreck tiki Lounge",
	"Shipwreck Tiki Lounge",
	"Shit Show del Fuego",
	"Shock-A-Chakra Project",
	...
	"Soular Tribe",
	"SOULICIOUS HEROES & SUPER VILLAINS",
	"Soulicious Heroes & Super Villains / Easy Village",
	"Sound Garden",
	"Source Maui Core",
	"South Bay HardCORE Camp",
	"South of All Borders",
	"Space Ambulance",
	"Space Bass",
	"Space Camp",
	"Space Cats!",
	...
	"Space Jam",
	"Space Lounge",
	"Space Monkey Mafia: The Theme Camp",
	"Space Nutz",
	"SPACE TRAVELERS",
	"Space Virgins",
	...
	"Spank the Monkey's Darwin Lounge",
	"Spanky's Village",
	"Spanky's Village",
	...
	"Sparkle Pony Corral",
	"Sparkle Pony's Costume Shop",
	"SparkleSpaz CarnyTron 20:13",
	"SparkleSpaz HoboTron 20:12",
	...
	"Spirit Dream",
	"Spirit Dream",
	"Spirit Dream Interpretation Caf",
	"Spirit Dream Interpretation Cafe",
	"SPK - Sparkle Pop Kitten",
	"Spock Mountain Research Labs",
	"Spontaneous Planning Camp",
	"Spudville Dust Monkeys Mr. Potato Head",
	"Squid Row",
	"Squirrel Army",
	"St. Petersburg",
	"St. Squishy's",
	...
	"Star Star",
	"STAR STAR ROADHOUSE",
	"Star Star Roadhouse @ Black Star Village",
	"Stardust Lounge",
	...
	"Street Life: Sesame Street meets Hip Hop Music",
	"Street Life: Childhood Meets Playa",
	"Stretchy Camp",
	"Struts & Bolts",
	"Sugar Bitch",
	"SugarBitch Camp",
	...
	"Sweaty Betty's Misting Parlor / Mon Salon",
	"Sweaty Betty's Misting Parlor / The Mon Salon",
	"Sweet & Sour Lemonade Stand",
	"The Sweet Spot",
	"Swing City",
	"Swish Embassy",
	"The Swish Embassy",
	...
	"The Automatic Subconscious",
	"The Avant Yard",
	"The Bartery",
	"The Big O-ven",
	"The Big O-vum",
	"The Biggest Little Theme Camp",
	"The black hole",
	"The black hole / gate perimeter & exodus",
	"The Black Rock Beacon",
	"The Black Rock Center for Unlearning",
	"The Black Rock City International Post Office Village",
	"The Black Rock Mafia",
	"The Blight",
	"The Boobs and the Bees",
	"The Booby Bar",
	"The Booby Bar with Terminal city V.",
	"The Boot Camp",
	...
	"The Church of Penis Christ of Latter-day Taints",
	"The Couch Prophecy",
	"The Cove",
	"The Cowbell Saloon",
	"The Craic Den",
	"The Creatures Metropolis",
	"The Crossroads",
	"The Crown Colective",
	...
	"The Hive",
	"THE HIVE / BEECHARGE!",
	"The Hollywood Death Squad",
	"The Hookah Lounge",
	"The Immaculate Temple of Kreation",
	"The Inconvenience Store",
	"The Inner Temple Tribe Camp",
	"The Institute",
	"The Institute Village",
	"The Itty Bitty Titty Twister",
	"The Janky Barge",
	...
	"The Modern Religion",
	"The Monkey Pit",
	"The Mudskipper's Urban Decay Cafe",
	"The mysterious wheel of uncertainty and mystical inclusion?",
	"The Neighborhood",
	"The Neighbourhood",
	"The New Barbarians",
	"The Oakltopia Oaktopuss",
	"The Oasis of the Sacred Cow",
	"The Offering Bowl",
	"The Oontz Pouch",
	"The OROgenous Zone",
	"The PaddyWagon Docking Station",
	"The Paradise Motel",
	"THE PERFECT WORLD",
	"The Phage",
	...
	"The Sand Trap",
	"The Santopalato",
	"The Scarsdale Laserium",
	"The Secret Gentlemen's Club",
	"The SEED",
	"The Seed",
	"The Shady Motherfuckers",
	"The Shallow End",
	"The Shiny Donkeys",
	"The Sonoran Sunrise Bar",
	"The Space Baggers",
	"The Space Between",
	"The Spenard Bar",
	"The Spoon Return Return Center",
	"The Steam Bath Project",
	"The Story Portal",
	"The Sunset Trip",
	"The Swedish Embassy",
	...
	"The Ultimate Fuzzy Celebration",
	"The Universe",
	"The V-SPoT",
	"The V-Spot",
	"The V-SPoT: Volunteer Here!",
	...
	"TimeStop UFO",
	"Tissue and a Plan",
	"TITTIES & PANCAKES MADNESS MUSEUM",
	"TITTIES N PANCAKES LOW FILL RANCH",
	"Tittyman Camp",
	"Tomorrows Panties",
	"ToneAge - CARNivAL PLEASURES",
	"ToneAge - FrumSanVanDencouver",
	"ToneAge - Karavantastique!",
	"ToneAge - rEvolution",
	"ToneAge SlimFast",
	"Tons O' Camps",
	"Toon Town Disco",
	...
	"Tramp Stamp Camp",
	"Tranquility Bass",
	"Tranquility Bass' Lunar Carnival",
	"Transcendence Tribe",
	"Transformation Beyond Zion",
	...
	"Tripod Camp",
	"Tropical Crocodile",
	"TROPICAL METROPOLIS TWISTER",
	"Tropical Treehouse",
	"Tropical Twister",
	"Troy Camp",
	"True Mirror Palace",
	"True Reflections Palace",
	"True Self Disco Verium",
	"Ts Nua",
	"Tsunami Bass Experience",
	"Tsunami Bass Experience ~Wobble tha' wave",
	"TSUNAMI CAMP",
	"Tsunami Camp",
	"Turkey Camp",
	"Tutu Camp",
	"Twilight Over Atlantis",
	"Twilight Spaghetti Theater",
	...
	"Undulate, Articulate & Bloom",
	"Unholy Cupcake Brigade",
	"Uni-Carny camp - Formerly al Azar",
	"Uniclan Presents: Carnie Cult",
	"Unicorn League",
	"Unintelligent Design Society",
	"Universal Babel Service",
	"Universal Citizens At Play",
	"Universe University",
	"Unknown Fields Division",
	"Unlikely Books & Brews",
	...
	"Vietnamese Iced Coffee Camp (VICC)",
	...
	"Voodoo Soup",
	"VooDoo Soup",
	"Vortex of Infinite Possibility",
	"Voted Best Camp",
	"VR Camp",
	"Vulcan Empire",
	"Vulcantown",
	"VW Bus Camp",
	"W*H*O*R*E's Oral Moistening Clinic",
	"WABI SABI",
	"Waiting for Edward",
	"Wanderer's Camp",
	"Wandering Dudeists",
	...
	"We Come in Pieces",
	"We Do! Do You?",
	"We Want To Learn Camp",
	"We're OK Village",
	"We're Ped-I-Culous",
	"Weasel Surprise",
	"Wedlock Ranch",
	"Weiner Zoo and Pussy Aquarium",
	"Welcome to Nowhere",
	"Well Actually...",
	"Well Made Mistakes",
	"Wet Dreams",
	"Wet Spot",
	"What is this, Board Games for Giants?!? Camp",
	"What Would Duck Tape Do?",
	"What Would Duct Tape Do",
	"What Would Duct Tape Do? (WWDTD?)",
	...
	"Where's Stephen Slater? Camp",
	"Where's The Killer Party? Camp",
	"Where's Waldo? Camp",
	"Where's Your Mom? Camp",
	"Whisker Biscuit",
	"Whiskey & Insults",
	...
	"Whiskey and Whores Saloon",
	"Whiskey Lounge",
	"Whisky and Dust @ Mile High Club",
	"White Bronco",
	...
	"WhiteTrashSuperstars F**K yr couch",
	"WhoofARTed?! & Get the F*%$ Out!",
	"Wide Awake",
	"Wide Awake Oasis Bar",
	"Wiener Zoo",
	"Wigg Party Camp",
	"Wild Oasis",
	"Wilde Oasis",
	...
	"Wonder Camp",
	"Wonder Whoasis",
	"Wonderlust Arcade Cast & Crew",
	"Woop Woop",
	"World Evolution Discoasis",
	"World Peace",
	"World Wide Wall",
	"World Wild Wall",
	"World's Most Inviting Climate Fruit Bar.",
	"WOW - Women Out Wandering",
	"Writes of Passage",
	"Wrongtown & [Phil in the Blank]",
	"Wulf Den",
	"X-Factor (machinedom)",
	"XPAT ALIEN",
	"XXx Ardent Heavy Industries xXx",
	"Yabba Dabba Do Me",
	"The Yard",
	"Yayflags Care-nival!",
	"Yellow Bike Shop",
	"Yellow Bikes",
	"Yellow Gorilla Lounge",
	"Yes Please",
	"Yes! Have Some",
	"Yes",
	"Yet Another Tiki Bar",
	...
	"Zookeeprz Camp",
	"Zuvuya Tribe",
	"ÆtherForce Home Bass - Project: Side Mission"
);
